        ...
        {user ? (
          ...
          !isCollapsed ? (
            <div className="pt-4 border-t border-slate-100 space-y-2">
              <Link
                href="/login"
                className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-purple-50 hover:text-purple-700 transition-colors"
              >
              ...
              <Link
                href="/register"
                className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold text-white bg-purple-600 hover:bg-purple-700 transition-colors shadow-xs"
              >
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col items-center gap-2">
              <Link href="/login" title="Sign In" className="p-2 text-slate-600 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors">
                <LogIn className="w-4 h-4" />
              </Link>
            </div>
          )
